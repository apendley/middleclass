...
h1. Features
  ...
  * The function @instance:instanceOf(Class)@ returns @true@ if @instance@ is an instance of the class @Class@
  * The function @Class:subclassOf(SuperClass)@ returns @true@ if @Class@ is a subclass of @SuperClass@
  * The function @Class:includes(mixin)@ returns @true@ if @Class@ (or one of its superclasses) includes @mixin@.
